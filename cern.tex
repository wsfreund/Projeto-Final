...
será descrito no Capítulo~\ref{cap:sf}, incluindo o algoritmo proposto pelo trabalho para a
...
completa natural, sem fendas, em \{phi}, assim como uma extração veloz dos sinais dos eletrodos 
...
$|\eta|=0$ do EMB. A quantidade de $X_0$ típicos para cada uma das camadas também são

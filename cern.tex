...
%
        \subfigure[Colisões Elásticas (EL).]{%
            \label{fig:col_el}
            \includegraphics[width=0.3\textwidth]{imagens/col_el.pdf}
        } \hspace{0.005\textwidth}
        \subfigure[Colisões de Difração Simples (DS).]{%
            \label{fig:col_ds}
            \includegraphics[width=0.3\textwidth]{imagens/col_ds.pdf}
        } \hspace{0.005\textwidth}
        \subfigure[Colisões de Difração Duplas (DD).]{%
            \label{fig:col_dd}
            \includegraphics[width=0.3\textwidth]{imagens/col_dd.pdf}
        }\\ %  ------- End of the first row ----------------------% 
        \subfigure[Colisões Inelásticas Não Difrativas Suaves (NDS) ]{%
            \label{fig:col_cs}
            \includegraphics[width=0.45\textwidth]{imagens/col_cs.pdf}
        }
        \subfigure[Colisões Inelásticas Não Difrativas Rígidas (NDR)]{%
            \label{fig:col_cr}
            \includegraphics[width=0.45\textwidth]{imagens/col_cr.pdf}
        }
%
    \end{center}
...
%
        \subfigure[Exemplos de Eventos de Minbias.]{%
            \label{fig:minb}
            \includegraphics[width=\textwidth]{imagens/eventos_minbias.pdf}
        }\\ 
        \subfigure[Exemplos de Eventos Adjacentes.]{%
            \label{fig:ue}
            \includegraphics[width=\textwidth]{imagens/ue.pdf}
        }
    \end{center}
...
\newacronym[type=Abrev]{bptx}{BPTX}{Serviços Eletrostáticos de Colheta de Feixes}
...
A manifestação das interações \glslink{em}{eletromagnéticas (EM)} com o meio do calorímetro 
...
As partículas \glslink{had}{hadrônicas (HAD)} são compostas de sistemas de quarks 

...
\newacronym[type=Abrev]{ds}{DS}{Difração Simples}
\newacronym[type=Abrev]{dd}{DD}{Difração Dupla}
\newacronym[type=Abrev,\glslongpluralkey={Não Difrativas}]{nd}{ND}{Não Difrativa}
...
%
        ...
        \subfigure[Colisões Não Difrativas (ND) Suaves]{%
            \label{fig:col_cs}
            \includegraphics[width=0.45\textwidth]{imagens/col_cs.png}
        }
        \subfigure[Colisões Não Difrativas (ND) Rígidas]{%
            \label{fig:col_cr}

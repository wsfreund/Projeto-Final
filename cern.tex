...
os pacotes serão então colididos nos \glspl{ip} experimentais. 
...
Obtendo as colisões de altas energias se faz necessário detectores
para realizar a medição dos eventos de colisão ocorridos. O   

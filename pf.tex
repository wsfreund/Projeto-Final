\documentclass[pdftex,12pt,twoside,openany,a4paper]{book}
...
\renewcommand*{\glsclearpage}{\clearpage} % Para não haver diferença entre página par e impar

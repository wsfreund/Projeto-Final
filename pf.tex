...
%\defglsdisplayfirst[Simb]{#1 #4 (denoted #3)}
%\defglsdisplay[Simb]{#1#4 (denoted #3)}

\makeglossaries

% add = sign in the list of abbreviations:

\renewcommand*{\glsclearpage}{\cleardoublepage} % Para não haver diferença entre página par e impar

...
utilização de um \glsdesc{sf}. Essa ferramenta realiza a seleção dos dados 
...
eventos de interesse, sendo necessário otimizar o \glsdesc{sf} de modo que 
...
O \glsdesc{sf} pode ser utilizado no ambiente em tempo real,

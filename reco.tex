...
Além disso, múons constituem outras assinaturas, uma vez que interagem
...
\centering
        ...
        \subfigure[Requisitos para o núcleo ser máximo local.]{%
            \label{fig:local_et}
...
abordada pelo algoritmo alternativo proposto, a fim de se identificar as
...
descobertas, como a do bóson de Higgs, entendimento de física ainda não bem
...
Serão abordados apenas os aglomerados \gls{em}, uma vez que somente os mesmos são
...
Os requisitos citados no \gls{sf} também se aplicam, sendo eles: \emph{loose}, 
...
Na execução, o \emph{egammaBuilder}

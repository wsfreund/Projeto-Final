...
\hline
\hline
\textbf{Tipo} & \textbf{Descrição} & \textbf{Nome da Variável} \\
\hline
\hline
...
\hline
\hline
Primeira camada do calorímetro \gls{em} & Largura lateral total do chuveiro &
\gls{weta} \\
...
e \emph{tight}, na região de $|\gls{eta}|<2,47$. Extraído de \cite{expected_perf_2011}.}
\label{tab:cortes_em}
\end{table}
